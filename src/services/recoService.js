...
export function buildAudiovisualPrompt(profile, avoid = {}) {
  ...
  return [
    ...
    'REPARTO OBLIGATORIO: 12 series + 12 películas (sobran a propósito: las repetidas de semanas anteriores se descartan).',
...
export function buildFoodPrompt(profile, avoid = {}) {
  ...
  return [
    ...
    'REPARTO OBLIGATORIO: 18 sitios (sobran a propósito: los repetidos de semanas anteriores se descartan), variando cocinas y barrios (no repetir los de semanas anteriores si los conoces por el contexto).',
